...
function binarySearch(array, first, last, key) {
  /**
   * Base condition: It will only execute when all of the array is searched and
  ...
  if (array[mid] === key) {
    ...
    /**
     * If element is greater than mid,then it can be only present in the other
     * half of the array as the array is sorted
     */
